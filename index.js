...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(lowerCaseAnimalNames){
    const lowerCase = lowerCaseAnimalNames.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(animalPop){
    const lowPopulationAnimals = animalPop.filter (function(item){
